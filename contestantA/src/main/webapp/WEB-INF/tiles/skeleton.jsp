		...
		<div class="page-header">
			<nav>
				<ul class="nav nav-pills pull-right">
					...
					<%-- <li role="presentation"><a href="<c:url value="/help" />">Help</a>
					</li> --%>
					
						<li role="presentation">
							<form action="<c:url value="/help" />" method="POST">
								<input type="hidden" name="${_csrf.parameterName}"
									value="${_csrf.token}" />
								<button class="btn-link" type="submit" title="Help">
			...
			<h1>
				<a class="appName" href="<c:url value="/" />">Nim with friends</a>
			</h1>
			<p class="lead">A ZERO-SUM GAME</p>
		</div>
